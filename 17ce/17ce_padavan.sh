...
start()
{
        ...
        wget --no-check-certificate -O /etc/storage/17ce/17ce_padavan_tmp.sh https://raw.githubusercontent.com/erebusx/r-app/17ce/17ce/17ce_padavan_tmp.sh 2>/dev/null  >/dev/null
