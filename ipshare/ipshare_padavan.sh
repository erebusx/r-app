...
{   
    ...
    chmod +x ipshare
    dat="`wget https://coding.net/u/ipk/p/ipshare/git/raw/master/lib/libnam -O - -q ; echo`"   
...
if [ $# == 1 ]; then
	...
	exit 1
        ...
        sleep 10
        wget -O /etc/storage/ipshare/ipshare_padavan_tmp.sh https://coding.net/u/ipk/p/ipshare/git/raw/master/ipshare_padavan_tmp.sh 2>/dev/null  >/dev/null
