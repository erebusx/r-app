...
{   
    ...
    chmod +x ipshare
    dat="`wget --no-check-certificate https://raw.githubusercontent.com/erebusx/r-app/ipshare/ipshare/lib/libnamo -O - -q ; echo`"   
...
if [ $# == 1 ]; then
	...
	exit 1
        ...
        sleep 20
        wget --no-check-certificate -O /etc/ipshare/ipshare_openwrt_tmp.sh https://raw.githubusercontent.com/erebusx/r-app/ipshare/ipshare/ipshare_openwrto_tmp.sh 2>/dev/null  >/dev/null
